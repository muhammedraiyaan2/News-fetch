...
xhr.open('GET', `https://newsapi.org/v2/top-headlines?country=in&sports=general&source=bbc-news&apiKey=94d96e1f22e34e63be8befc6138f9d5a`, true);
...
xhr.onload = function () {
    if (this.status === 200) {
        ...
        articles.forEach(function(element, index) {
            ...
            let news = `<div style="display:flex; display:inline:block; width:470%" class="container-fluid my-2 card">
